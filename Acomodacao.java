...
public class Acomodacao {
   ...
   */
  public static void lerArquivo(String arquivo, Acomodacao[] acomodacoes) throws IOException {
  ...
  /**
   * Método que pesquisa a acomodação pelo ID.
   * 
   * @param acomodacoes vetor de acomodações
   * @param scanner     objeto de leitura do teclado
   */
  public static void pesquisarAcomodacao(Acomodacao[] acomodacoes, Scanner scanner) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Acomodacao[] acomodacoes = new Acomodacao[contarLinhasArquivo(arquivo)];
    lerArquivo(arquivo, acomodacoes);
    pesquisarAcomodacao(acomodacoes, scanner);
    scanner.close();
  }
}