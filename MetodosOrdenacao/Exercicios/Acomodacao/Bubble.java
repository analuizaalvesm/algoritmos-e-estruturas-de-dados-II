...
public class Bubble {
  ...
  public Bubble(int roomId2, int hostId2, String roomType2, String country2, String city2,
  ...
  public static void sort(Bubble[] array, int n) {
    for (int i = (n - 1); i > 0; i--) {
      for (int j = 0; j < i; j++) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Bubble[] quartos = new Bubble[127992];
    ...
    try (BufferedReader lerAirbnb = new BufferedReader(new FileReader(arquivo))) {
      ...
      Bubble[] quartosFiltrados = new Bubble[numeroQuartos];
      for (int i = 0; i < numeroQuartos; i++) {
        String pesquisa = sc.next();
        for (Bubble acomodacao : quartos) {
      ...
      for (Bubble acomodacao : quartosFiltrados) {
        acomodacao.imprimir();
      }
